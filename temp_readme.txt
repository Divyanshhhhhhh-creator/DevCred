...
flowchart TB
    ...
    subgraph Contracts["Smart Contract Suite"]
        IS[IssueStaking<br/>• createIssue<br/>• acceptAssignment<br/>• submitWork<br/>• completeByProof]
        DT[DeveloperToken<br/>• ERC20<br/>• Reputation Backed]
        TF[TokenFactory<br/>• launchToken<br/>• Registry]
        BC[BondingCurve<br/>• GDA Pricing<br/>• Buy/Sell]
    end
...
flowchart TB
    subgraph Factory["DeveloperTokenFactory"]
        F1["launchToken(name, symbol, gdaStartPrice, gdaEndPrice)"]
        F1 --> DT["DeveloperToken<br/>ERC20 Token"]
        F1 --> BC["SimpleBondingCurve<br/>GDA Pricing"]
    end
...
flowchart LR
    subgraph Inputs["Input Metrics"]
        I1["Repository Activity<br/><small>PR count, Lines of Code</small>"]
        I2["Tenure<br/><small>Months of history</small>"]
        I3["Language Stack<br/><small>Programming diversity</small>"]
        I4["Quality<br/><small>Merge rate, Issues resolved</small>"]
        I5["OSS Contribution<br/><small>Open source projects</small>"]
        I6["Consistency<br/><small>Regular contribution pattern</small>"]
    end
    ...
    subgraph Output["Output"]
        O1["REPUTATION<br/>SCORE<br/>0-1000"]
    end
